...
// WirtualnaKamDoc.cpp: implementacja klasy CWirtualnaKamDoc
//
...
IMPLEMENT_DYNCREATE(CWirtualnaKamDoc, CDocument)

BEGIN_MESSAGE_MAP(CWirtualnaKamDoc, CDocument)
END_MESSAGE_MAP()


// Tworzenie/niszczenie obiektu CWirtualnaKamDoc

CWirtualnaKamDoc::CWirtualnaKamDoc() noexcept
{
	// TODO: tutaj dodaj jednorazowy kod konstruowania

}

CWirtualnaKamDoc::~CWirtualnaKamDoc()
{
}

BOOL CWirtualnaKamDoc::OnNewDocument()
{
...
// Serializacja klasy CWirtualnaKamDoc

void CWirtualnaKamDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// Obsługa miniatur
void CWirtualnaKamDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CWirtualnaKamDoc::InitializeSearchContent()
{
...
void CWirtualnaKamDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Diagnostyka klasy CWirtualnaKamDoc

#ifdef _DEBUG
void CWirtualnaKamDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CWirtualnaKamDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
